...
export default async function revoke(apiUrl: string, service: OAuthService, payload: { oauthCredentialId: number }, accessToken: string): Promise<RequestResponse<string, 204 | 401 | 404 | 422>> {
    try {
